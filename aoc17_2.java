...
public class aoc17_2 {
    /**
     * binary search for the lowest value of A that allows 
     */
    static char grid [][];
    static int A;
    static int B;
    ...
    public static void main(String[] args) throws IOException {
        ...
        PrintWriter pr = new PrintWriter(new FileWriter("aoc17_2.out"));
